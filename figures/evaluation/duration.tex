\pgfplotsset{
    ...
    duration plot style/.style={
        ...
        ylabel=\textcolor{darkslategray38}{Duration per explanation (s)},
        ymajorgrids,
        ymajorticks=true,
...
\matrix [
    ...
    column sep=1em
              ...
              &\footnotesize  \textit{random} &\footnotesize \textit{temporal} &\footnotesize \textit{spatio-temporal} &\footnotesize \textit{local-gradient} &\footnotesize no selection strategy \\
    \footnotesize Correct prediction & \fill[forestgreen4416044] (-17.5pt,0) rectangle (17.5pt, 7.5pt); & \fill[darkorange25512714] (-17.5pt,0) rectangle (17.5pt, 7.5pt); & \fill[crimson2143940] (-17.5pt,0) rectangle (17.5pt, 7.5pt); & \fill[steelblue31119180] (-17.5pt,0) rectangle (17.5pt, 7.5pt); & \fill[black25] (-17.5pt,0) rectangle (17.5pt, 7.5pt); \\
    ...
    %Wrong predictions & \ref{plt_fs_greedy_random} & \ref{plt_fs_greedy_closest} & \ref{plt_fs_greedy_recent} & \ref{plt_fs_greedy_local-gradient}  \\
};
