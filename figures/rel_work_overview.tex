...
\begin{tikzpicture}[level 1/.style={sibling distance=80mm}, edge from parent/.style={->,draw}, >=latex]
    \node[root] {\gls{tgnn} Explanations}
        ...
        \node[below of = c21, text width=9em, xshift=1em] (c211) {T-GNNExplainer \cite{xia_explaining_2023}};
        \node[below of = c211, text width=9em] (c212) {TempME \cite{chen_tempme_2023}};
