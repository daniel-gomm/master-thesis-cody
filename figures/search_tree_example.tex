...
\footnotesize
    \node [root] (r) {$n_0 = (\varnothing, 0.98, null, \{n_1, n_2\}, 94, 0, 1)$}
      child {
        node [level 2] (n1) {$n_1 = (\{\varepsilon_1\}, 0.77, n_0, \{n_3, n_4\}, 57, 0.21, 1)$}
        child {
      ...
      child {
        node [level 2] (n2) {$n_2 = (\{\varepsilon_{l}\}, 0.87, n_0, \{n_5, n_6\}, 11, 0.11, 1)$}
        child {
