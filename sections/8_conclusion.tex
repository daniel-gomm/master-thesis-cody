...
%The removal of a specific set of events from the input graph is referred to as perturbation
...
Extensive evaluation reveals that \gls{cftgnn} outperforms \gls{greedycf} and a contemporary factual explanation method, providing counterfactual examples more frequently and with lower complexity while keeping the explanation time acceptable.
%An extensive evaluation shows that \gls{cftgnn} provides counterfactual examples more frequently and with lower complexity than \gls{greedycf} or other contemporary explanation approaches while keeping the explanation time acceptable. 
